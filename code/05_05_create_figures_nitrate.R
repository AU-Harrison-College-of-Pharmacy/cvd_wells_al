...
preds_hypertensive <- pool_predictions(lapply(f_hypertensive, 
                                              predict_response, 
                                              terms = c("amt_centered_scaled_mean_pct_wells_cbg [-0.78:2.9]", "amt_median_nitrate_concentration_centered_scaled [-1, 0, 1]", "cat_age_group"),
...
ggsave("figs/05_04_hypertensive_deaths_ixn_nitrate.pdf",
...
f_ischemic <- read_rds("/Volumes/Projects/usgs_cvd_wells_al/output/04_ischemic_deaths_poisson_model_ixn_nitrate.rds")
...
ggsave("figs/05_04_ischemic_deaths_ixn_nitrate.pdf",
...
f_stroke_cerebrovascular <- read_rds("/Volumes/Projects/usgs_cvd_wells_al/output/04_stroke_cerebrovascular_deaths_poisson_model_ixn_nitrate.rds")
...
ggsave("figs/05_04_stroke_cerebrovascular_deaths_ixn_nitrate.pdf",
...
f_diabetes <- read_rds("/Volumes/Projects/usgs_cvd_wells_al/output/04_diabetes_deaths_poisson_model_ixn_nitrate.rds")
...
ggsave("figs/05_04_diabetes_deaths_ixn_nitrate.pdf",
...
ggsave("figs/05_04_combined_plots_ixn_nitrate.pdf",
       p,
       width = 11, height = 5)
...
ggsave("figs/05_04_combined_plots_ixn_nitrate_no_diabetes.pdf",
       p_no_diabetes,
       width = 11, height = 5)
