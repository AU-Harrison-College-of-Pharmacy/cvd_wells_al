...
df_hypertensive <- df %>%
  ...
  select(id_census_block_group, cat_age_group, amt_centered_scaled_area_land, amt_area_water, n_population_times_4, amt_centered_scaled_mean_pct_wells_cbg, n_hypertensive_deaths, cat_physiographic_region, amt_centered_scaled_pct_aa_only, cat_rural, amt_percent_agricultural_land_use_centered_scaled)
...
df_ischemic <- df %>%
  ...
  select(id_census_block_group, cat_age_group, amt_centered_scaled_area_land, amt_area_water, n_population_times_4, amt_centered_scaled_mean_pct_wells_cbg, n_ischemic_deaths, cat_physiographic_region, amt_centered_scaled_pct_aa_only, cat_rural, amt_percent_agricultural_land_use_centered_scaled)
...
df_stroke_cerebrovascular <- df %>%
  ...
  select(id_census_block_group, cat_age_group, amt_centered_scaled_area_land, amt_area_water, n_population_times_4, amt_centered_scaled_mean_pct_wells_cbg, n_stroke_cerebrovascular_deaths, cat_physiographic_region, amt_centered_scaled_pct_aa_only, cat_rural, amt_percent_agricultural_land_use_centered_scaled)
...
df_diabetes <- df %>%
  ...
  select(id_census_block_group, cat_age_group, amt_centered_scaled_area_land, amt_area_water, n_population_times_4, amt_centered_scaled_mean_pct_wells_cbg, n_diabetes_deaths, cat_physiographic_region, amt_centered_scaled_pct_aa_only, cat_rural, amt_percent_agricultural_land_use_centered_scaled)
